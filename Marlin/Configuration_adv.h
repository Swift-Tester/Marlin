...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  46, 35 }, { 200,  35 }, { 200, 200 }, { 46, 200 } }
...
#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define BROWSE_MEDIA_ON_INSERT          // Open the file browser when media is inserted //Swift-tester on

  #define EVENT_GCODE_SD_ABORT "G91\nG1 Z10\nG90\nG1 X0 Y235\nM106 S0\nM104 S0\nM140 S0"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27") Swift-Tester
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement). //Swift-Tester
  ...
  //#define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping
    ...
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor  //Swift-Tester enable 20201107
  #endif
#endif
 ...
 */
#define LIN_ADVANCE // Swift-tester
 ...
 */
#define FWRETRACT //Swift-Tester
#if ENABLED(FWRETRACT)
//#define FWRETRACT_AUTORETRACT           // Override slicer retractions //Swift-Tester
  #if ENABLED(FWRETRACT_AUTORETRACT)
    #define MIN_AUTORETRACT 0.1           // (mm) Don't convert E moves under this length
    #define MAX_AUTORETRACT 10.0          // (mm) Don't convert E moves over this length
  #endif
  #define RETRACT_LENGTH 0.5                // (mm) Default retract length (positive value) //Swift-Tester
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      120  // (mm) The length of filament for a complete unload. (Swift-Tester BMG DD)
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   100  // (mm) Load length of filament, from extruder gear to nozzle. (Swift-Tester BMG DD)
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
